...
exports.default = _default;
  ...
  return _vm.icon
    ? _c("svg", { staticClass: "icon" }, [
        _c("use", { attrs: { "xlink:href": "#k-" + _vm.icon } })
      ])
    : _vm._e()
}
var staticRenderFns = []
    ...
    try {
      for (var _iterator = this.$el.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (node.nodeName.toLowerCase() !== 'button') {
          console.warn("g-button-group\u7684\u5B50\u5143\u7D20\u5FC5\u987B\u662Fg-button, \u4F60\u5199\u7684\u662F".concat(node.nodeName.toLowerCase()));
        }
      }
    } catch (err) {
...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "group-wrapper" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
render._withStripped = true
...
_vue.default.component('g-button', _button2.default);
...
{
  //动态创建按钮
  var Constructor = _vue.default.extend(_button2.default); //拿到构造函数
  ...
  var href = useElement.getAttribute('xlink:href'); // expect(href).to.eq('#i-loading')

  expect(href).to.eq('#k-loading1');
}
{
  var _Constructor = _vue.default.extend(_button2.default); //拿到构造函数
...
{
  var _Constructor2 = _vue.default.extend(_button2.default); //拿到构造函数
  ...
  var spy = _chai.default.spy(function () {}); // vm.$on('click', function(){
  //     expect(1).to.eq(1)
  // })
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2177" + '/');
